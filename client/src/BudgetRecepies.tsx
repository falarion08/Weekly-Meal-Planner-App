...
function BudgetRecepies() {
  ...
  return (
    <div className="relative min-h-screen bg-green-100 flex flex-col items-center justify-center space-y-8 ">
      ...
      <h1 className="text-4xl font-bold text-center text-[#006400] animate-flyInFromRight">Low-Cost Recipes</h1>
      ...
      <h1 className="text-4xl font-bold text-center text-[#006400] animate-flyInFromRight">Cooking Tips</h1>
      <div className="animate-slide-in-from-left animate-flyInFromLeft bg-white p-6 rounded shadow-lg w-full max-w-4xl text-center hover:scale-105 hover:z-10 transition-transform duration-300 ease-in-out ">
        <p className="text-gray-700 text-lg">
      ...
      <h1 className="text-4xl font-bold text-center text-[#006400] animate-flyInFromRight">Meal Planning</h1>
      <div className="animate-slide-in-from-left animate-flyInFromLeft bg-white p-6 rounded shadow-lg w-full max-w-4xl text-center hover:scale-105 hover:z-10 transition-transform duration-300 ease-in-out ">
        <p className="text-gray-700 text-lg">
